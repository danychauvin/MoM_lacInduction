...
(myplots[['FLIM_decay']] <- bind_rows(
  ...
  read_delim(here('./data_FLIM/decay_curves/decay_noGFP.dat'), delim='\t', skip=2, na = "---", 
    ...
    mutate(sample='Autofluorescence (GFP)',
...
In order to estimate whether FLIM data can be used to measure difference in GFP before the switch, we proceed as follow: 
