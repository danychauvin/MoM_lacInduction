...
- We show that the discrete nature of inducer sensing can lead to phenotypic diversification during gene regulatory responses (this requires a positive feedback and no sensing in the “zero state”). This constitutes a new mechanisms to explain the origin of phenotypic heterogeneity in gene circuits. An important implication of this mechanism is that the final population state does not depend only on the final condition but also critically of the initial condition before the switch.
...
1D. Distributions with IPTG tickling / LacI plasmid
...
## Figure 3: The induction dynamics controls the growth response at the switch (formerly S12)
3A. Growth lag = f(induction lag)

3B. Histo of growth lags (maybe overlaid on histo of induction lags??)

NB: on this Dany commented that this is one case where the “growth phenotype” is revealed only after the environmental change i.e. that difference in growth becomes only visible in lactose although the difference in terms of Lac proteins content is already present in glucose; he made a point that this illustrates how fitness/growth is environment dependent even for cells simply in different phenotypic states. I’ve not decided yet whether it’s obvious or smart and relevant…



## Figure 4: The discrete nature of inducer sensing leads to phenotypic diversification during a switch to lactose.
...
4C. Population lag in diauxie experiments is shorter when more lactose is provided (indep of glucose concentration)

NB: 4C is also true for different SC1 strain (might go in 4C or in a SI figure depending on how I show it)
...
- in principle it would be possible to set the stage starting with the diauxie experiments and the shorter population lags at higher lactose concentration; not sure what we would gain though (I’m not surfe that the single-cell experiments we’ve done are natural things to do to understand this…). Can you think of a striking way to use them? (I realise this is a stupid question since you havent seen a figure; I pasted what the “raw” data look like at https://vannimwegenlab.slack.com/archives/C9R5LA70Q/p1562162859000100)
0) 

- it would be nice to have the FLIM results in this article (but I don’t know whether they will ever come)
- the high heritability of the induction lag and growth lag is a strong signature of this “discrete inducer sensing”; could make a nice point with a figure / panel (maybe squeezed in 4A??)
